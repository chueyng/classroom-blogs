...
Post.destroy_all
p1 = Post.create :title => 'Writing Time', :body => 'Write an article about yourself', :user_id => u1.id, :image => 'https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcQv4KVjHjNoet7z-3sPmv_I6MVMTXe4oblEEXuiJdh4SNuRGq27mr884V1h' 
p2 = Post.create :title => 'Reading Time', :body => 'Read a fairy tales story', :user_id => u2.id, :image => 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTIAKFsDoeTqZr-fAGVQfqDe-8v0KD7GpyN5IPZGW9oA-Xg97V3'
